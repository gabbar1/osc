                ...
                CommonButton(
                  onTap: (){
                    if(registerFormKey.currentState.validate()){
                      print("Validated");
                      registerController.register(email: registerController.emailController.text,phone: registerController.phoneController.text,name: registerController.nameController.text,dob: commonDatePicker.getSelectedDate);
                ...
                CommonButton(
                    onTap: (){
                      if(otpFormKey.currentState.validate()){
                        print("Validated");
                        registerController.signUp(context: context,otp: registerController.otpController.text);
                      }else{
                        print("not validated");
                      }
                    },
